...
<JHorizontal width="75vw" style={{  }}>
  ...
  <CodeWrapper>
    <h3>Markdown + JSX</h3>
    <div>read, scroll, <br/> tap, pinch, zoom, <br/> rotate, type, shake, <br/> drag, drop, <br/> swipe, flip, rotate</div>
    <p></p>
  </CodeWrapper>
</JHorizontal>
</AppearOnly>
...
<Notes>
The new content was really engaging and easy for content authors to create. It took better advantage of the capabilities of people's devices and learning styles, letting them scroll and tap, pinch, rotate, shake, swipe, flip, rotate, watch gifs and videos, and more.
</Notes>
