...
"CHECK THAT HIGHLIGHT MODE IS ON AND AT EDGE OF SCREEN"
</Notes>
...
<Notes>
I created React components to show card with information about each tool, and used MDX to make it possible to embed those in the content.

This is just one way MDX can be used. But before I go into others, I want to talk about fundamentally why a technology like MDX matters. What problem can it solve for JAMstack builders? To do that, I want to tell you a story. I won't tell you a case study since those can be kinda boring, and we're at a pub. I'm going to tell you a fairy tale instead. 
</Notes>
...
King Markdown is so adamant about having his content his way that he tried to build a ^^ Great Wall of Text at the kingdom's southern border. However, no one thought it was a good idea and he never got the money for it.
</Notes>
...
<Notes>
King Markdown had a daughter, Princess JavaScript. That's not a normal name but she’s not a normal princess.

Princess JavaScript is a trained developer, she builds and loves beautiful and responsive interfaces, and she likes to use many different ^^ gestures to interact with her content; to tap, pinch, rotate, shake and swipe.
...
<Notes>
As you can imagine, there's been a lot of tension in the royal palace, similar to what some of you may have even seen in your content teams. Although some readers prefer very linear, textual content, others prefer more dynamic and interactive content. Content teams, then and now, struggle to serve both audiences and keep up with the latest trends.
</Notes>
...
The engineers stayed up all night pair-programming and built some interactive content for browsing the world's best football players, ^^ just in time for the Women's World Cup. The content was a huge hit.
</Notes>
...
<Notes>
The kingdom rejoiced and there was much dancing. Traffic went back up so even the king was happy. The kingdom's content would forever be more engaging, inclusive and easier for content authors to create.
</Notes>
...
<Notes>
It took better advantage of people's preferences and the capabilities of their devices, ^^ letting them ... ... and more.
...
<Notes>
Because the presentation is MDX and we have a running React app, we can actually change the values of the props on the fly too.

Let me click into the MDX snippet and let's change the King's properties. Maybe the king is lonely and needs some friends. I can change the src param. Can't see too well? Changing the height param makes it bigger.

I hope you've found this presentation a little more fun and engaging because we can interact with it. If I can do this in a presentation, imagine how you can use MDX to spice up your JAMstack content.
</Notes>
...
<Notes>
There are four use cases where you can start using MDX right now. The first in site widgets like forms, social widgets and comments. Second is visual storytelling and data visualization. Third is wrapping design systems so that authors can take advantage of them without writing raw HTML, classes and styles. And last but not least, you could even let authors build entire pages from a standard set of blocks, like custom landing pages.
</Notes>
...
<Notes>
So how you can you get started?

MDX Plugins exist for Gatsby, Next.js, Webpack, Parcel and much more. Try MDX soon and bring peace and awesomeness to your content kingdom.
</Notes>
