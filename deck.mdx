...
<JHorizontal>
  <KingMarkdown src="/images/king-markdown-2.png" hoverable={false} />
  <Image src="/images/great-wall-of-text.png" style={{ height: '60vh', borderRadius: '500px' }} />
</JHorizontal>
</AppearOnly>
...
<Notes>
So as you can imagine, there's been a lot of tension in the royal palace, similar to what some of you may have even seen in your content teams. Although some prefer very linear content, competition for people's attention and preferences are changing, and more dynamic and interactive content is becoming the norm.
</Notes>
...
<Notes>
The kingdom's content experts, known as the Royal Academy of Content, were struggling to please both king and princess, and they were losing traffic to other kingdoms.
...
The engineer stayed up all night coding and built a prototype of a news article with an interactive timeline, and the rest was history. The kingdomw rejoiced.

Because traffic was up across the board, even the king was happy.
</Notes>
...
<Flex>
<Box width={1/3}>
tap, pinch, rotate, shake, swipe, flip, rotate & more
</Box>
</Flex>
