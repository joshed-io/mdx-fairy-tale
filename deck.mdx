...
<KingMarkdown codeSnippet={snippetKingMarkdown} />

<Notes>
Searching, searching, searching... a ha!

The scepter has found some code after all. All along, King Markdown was just a React component. rike most React components, it accepts props, has event handlers, and renders some DOM, in this case an image. This component is actually embedded here in my slides, for real. The slides are written in MDX using a really great framework called mdx-deck. 
