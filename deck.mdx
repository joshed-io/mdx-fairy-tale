...
import { book as mdxTheme } from '@mdx-deck/themes'
...
# 👑 👸<br/> MDX: content for kings and princesses

---

<Split>
<h2 style={{ width: '40vw' }}>I'm Josh</h2>
...
<div style={{ width: '40vw' }}>
<img src="/images/algolia-logo.png" css={{ }} />
</div>
<div style={{ width: '40vw' }}>
<img src="/images/developermode-logo-black.png" css={{ }} />
</div>
</AppearOnly>
...
<Notes>
Hi I’m Josh, a developer advocate formerly at Algolia and now the co-founder of DeveloperMode, where we do developer-relations-as-a-service and get to play with lots of cool tech. Like MDX, which is what I'll talk to you about tonight.
</Notes>
