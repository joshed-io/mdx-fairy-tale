...
<JHorizontal width="80vw">
  <div style={{ margin: '0 50px' }}>
    <img src="/images/female-footballers-interactive-content.gif" css={{ width: '60vw', border: '1px solid #0a0a0a' }} />
  </div>
  <div>
    <img src="/images/adventure-time-dance-party.gif" css={{ width: '30vw' }} />
  </div>
</JHorizontal>
</AppearOnly>
...
The engineers stayed up all night pair-programming and built some interactive content for browsing the world's best football players. ^^ The kingdom rejoiced and the rest was history. Traffic went back up and there was much dancing.
</Notes>
