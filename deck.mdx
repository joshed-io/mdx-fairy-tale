...
import { smallKingSnippet, bigKingSnippet, snippetKingMarkdown } from 'snippets/snippets-mdx'
...
<Image src="/images/developermode-logo-black.png" />
</AppearOnly>

</JSplit>

<Notes>
Hi I’m Josh, a developer advocate formerly at Algolia and now the co-founder of DeveloperMode, where we do developer-relations-as-a-service and get to play with lots of cool tech. Like MDX, which is what I want to talk to you about tonight.
</Notes>
...
<img src="/images/awesome-stacks-logo.svg" />

<Notes>
I first used MDX when building an open source project Awesome Stacks. Awesome Stacks is like an awesome list for stacks on steroids, because an entire Gatsby site is built from the README content. Each awesome stack gets its own page that shows information about each tool in the stack pulled from the GitHub and StackShare GraphQL APIs. I used MDX to allow these GitHub and StackShare tool cards to be shown inline with the content.
...
todo: screenshot and show GitHub component syntax; awesomestacks.dev
</Notes>
...
He's so adamant about having his content his way that he tried to build a Great Wall of Text at the kingdom's southern border, but since no one in Congress supported it and it was a perfectly stupid idea, the King never got the money for his wall and it was never built.
</Notes>
...
<Notes>
King Markdown has a daughter, Princess JavaScript. Not a normal name but she’s not a normal princess.
...
*put highlight on king, or trigger secondary keystroke*
*code appears*

The scepter has found some code after all. All along, King Markdown was just a React component.

**switch to magnify and move sceptre closer**

Like most React components, it accepts props, has event handlers, and renders some DOM, in this case an image.

This component is actually embedded here in my slides, for real. The slides are written in MDX using a really great framework called mdx-deck. 
